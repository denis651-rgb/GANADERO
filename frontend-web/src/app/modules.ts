...
export const appModules: AppModuleDefinition[] = [
  ...
  { key: 'reproduccion', label: 'Reproducción', path: '/reproduccion', icon: Activity, phase: 3, permission: 'REPRODUCCION_VER', status: 'EN_DESARROLLO' },
  { key: 'sanidad', label: 'Sanidad', path: '/sanidad', icon: HeartPulse, phase: 3, permission: 'SANIDAD_VER', status: 'EN_DESARROLLO' },
  { key: 'alertas', label: 'Alertas', path: '/alertas', icon: Bell, phase: 3, permission: 'ALERTA_VER', status: 'EN_DESARROLLO' },
