...
export interface Miembro { id: string; usuarioId: string; nombres: string; apellidos: string; telefono?: string; cargo?: string; estado: 'ACTIVO' | 'BLOQUEADO' | 'INACTIVO'; accesoTodasPropiedades: boolean; ultimoAccesoAt?: string; perfilVersion: number; version: number; roles: UsuarioRol[]; propiedadesPermitidas: string[] }
