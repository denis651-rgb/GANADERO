...
import { createPotrero, listPotreros, listTiposPasto, updatePotrero } from '@/features/potreros/api'
...
export function PotrerosPage() {
  ...
  const changeState = useMutation({
    ...
    onSuccess: () => client.invalidateQueries({ queryKey: ['potreros'] }),
  })
