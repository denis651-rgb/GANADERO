...
public record CrearPlanItemRequest(@NotNull TipoActividadSanitaria tipoActividad,UUID productoId,@Size(max=300) String productoRecomendadoTexto,
 ...
 @Size(max=60) String especieAplicable){CrearPlanItemCommand command(){return new CrearPlanItemCommand(tipoActividad,productoId,
 ...
 origenRegulatorio,especieAplicable==null||especieAplicable.isBlank()?"BOVINO":especieAplicable);}}
