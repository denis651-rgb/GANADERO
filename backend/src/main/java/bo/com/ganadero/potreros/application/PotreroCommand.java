...
public record PotreroCommand(UUID propiedadId,UUID sectorId,String codigo,String nombre,BigDecimal superficieHa,
 UUID tipoPastoId,BigDecimal capacidadUa,Boolean tieneAgua,EstadoPotrero estado,String geometriaWkt,Boolean activo,
 Boolean quitarSector,Boolean quitarTipoPasto,Boolean quitarSuperficie,Boolean quitarCapacidad,Long version) {}
