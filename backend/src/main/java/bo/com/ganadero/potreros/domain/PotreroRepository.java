...
public interface PotreroRepository { List<Potrero> findAll(UUID empresa,Set<UUID> allowed,UUID propiedad,EstadoPotrero estado,UUID sector); PotreroPage findPage(UUID empresa,Set<UUID> allowed,PotreroFilter filter);
