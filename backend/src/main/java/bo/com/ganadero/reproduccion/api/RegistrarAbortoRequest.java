...
public record RegistrarAbortoRequest(@NotNull UUID animalId,UUID gestacionId,UUID servicioId,@NotNull @PastOrPresent LocalDate fechaEvento,
 ...
 @Size(max=1000) String observaciones,@NotNull UUID cicloGestacionId){RegistrarAbortoCommand command(){return new RegistrarAbortoCommand(animalId,gestacionId,servicioId,
 fechaEvento,edadGestacionalEstimada,causa,diagnostico,veterinarioId,observaciones,cicloGestacionId);}}
