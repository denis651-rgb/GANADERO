...
public record ActualizarConfiguracionRequest(
 ...
 @Size(min=4,max=20) String nuevoPin,Boolean quitarPin,@NotNull Long version){
 ConfiguracionCommand command(){return new ConfiguracionCommand(zonaHoraria,moneda,unidadPeso,unidadSuperficie,
  ...
  diasGestacionEstimada,comprimirImagenes,calidadImagen,nombreUsuario,nuevoPin,quitarPin,version);}}
