...
public record ActualizarConfiguracionRequest(
 ...
 @Min(0) Integer diasAlertaPreparto,@Min(0) Integer diasAlertaVacunacion,@Min(0) Integer diasSinPesaje,@Min(0) Integer diasAlertaDestete,
 ...
 @Size(min=4,max=20) String nuevoPin,Boolean quitarPin,@Min(0) Integer diasToleranciaPesoCompra,@NotNull Long version){
 ConfiguracionCommand command(){return new ConfiguracionCommand(zonaHoraria,moneda,unidadPeso,unidadSuperficie,
  diasAlertaPreparto,diasAlertaVacunacion,diasSinPesaje,diasAlertaDestete,diasDiagnosticoPostServicio,
  diasGestacionEstimada,comprimirImagenes,calidadImagen,nombreUsuario,nuevoPin,quitarPin,diasToleranciaPesoCompra,version);}}
