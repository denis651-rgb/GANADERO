...
public enum ErrorCode {
    ...
    LOT_HAS_ACTIVE_ANIMALS(HttpStatus.UNPROCESSABLE_CONTENT, "El lote tiene animales activos y no puede cerrarse."),
    ANIMAL_ALREADY_IN_ACTIVE_LOT(HttpStatus.CONFLICT, "El animal ya pertenece a un lote activo."),
    ANIMAL_NOT_IN_LOT(HttpStatus.UNPROCESSABLE_CONTENT, "El animal no pertenece al lote indicado."),
