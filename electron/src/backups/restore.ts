...
import { DATABASE_ENTRY, extractDatabaseEntry, readManifestFromArchive, verifyExtractedHash, type RespaldoManifest } from './archive'
...
const MAX_ARCHIVO_BYTES = 5 * 1024 * 1024 * 1024 // 5 GB
...
/** Pasos 9-17: crea un respaldo preventivo, detiene el backend, reemplaza la base y reinicia; revierte si el arranque falla. */
  ...
  return conLockDeOperacion(async () => {
    ...
    try {
      ...
      try {
        ...
        // Paso 17: si el arranque falla, revertir automáticamente a la base anterior.
